...
# [4] f function implementation
# [5] Encryption round implementation
# [6] Decryption round implementation
# [7] Padding and string processing
# [8] ECB encoding and decoding
# [9] CBC mode
# =================
...
def des_decrypt(cipher_bits: list[int], key_str: str) -> str:
    ...
    round_keys = generate_keys(key_bits)[::-1]  # Reversed keys
